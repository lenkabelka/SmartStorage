...
class AddThingProjection(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        checkbox_label = QLabel("Соотношение сторон изображения в px соответствует действительному соотношению сторон вещи:")
        ...
        layout_for_scales.addWidget(QLabel("Размер вещи по x:"))
        layout_for_scales.addWidget(self.x_sm)
        layout_for_scales.addWidget(QLabel("Размер вещи по y:"))
    ...
    def update_text_y(self):
        if self.checkbox.isChecked():
            if not self.image:
                QMessageBox.warning(self, "Добавьте проекцию вещи",
                                    "Для расчёта соотношения сторон необходимо"
                                    " вначале добавить проекцию вещи!")
                return
            else:
